...
public class PouleRepository : IPouleRepository
{
    ...
    public PouleRepository(DesignDbContext designDbContext)
    {
        ...
        _poules = designDbContext.Poules;
    }
    ...
    public async Task<IEnumerable<Poule>> GetAllByTournamentAndRoundAsync(TournamentId tournamentId, RoundId roundId)
    {
    ...
    public async Task<Poule> GetByIdAsync(PouleId id)
    {
        ...
        return await _poules.SingleAsync(p => p.Id == id);
    }
