...
public sealed class CompetitionPouleName : ValueObject
{
    public const int MaxLength = 100;

    public string Value { get; }

    private CompetitionPouleName(string value)
    {
        Value = value;
    }

    public static CompetitionPouleName Create(string value)
    {
        ...
        return new CompetitionPouleName(value);
    }
