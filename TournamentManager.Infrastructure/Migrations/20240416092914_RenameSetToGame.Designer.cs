...
namespace TournamentManager.Infrastructure.Migrations
{
    ...
    [Migration("20240416092914_RenameSetToGame")]
    partial class RenameSetToGame
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TournamentManager.Domain.PouleMember", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TournamentManager.Domain.PouleMember", b =>
                {
                    b.HasOne("TournamentManager.Domain.Member", "Member")
                        .WithMany()
